...
<body>
    ...
    <div id="mainContainer" class="mx-auto md:pt-4 pt-1 px-4 md:px-0 max-w-5xl text-center container">
        <h1 class="font-black text-center break-normal text-base md:text-2xl mx-auto">
            [STATE] Seniors: 2024 Medicare Advantage Plans Can Help You Save Thousand In additional Benefits. Check your Eligibity now
        </h1>
        <img class="mx-auto my-2 w-full md:w-3/4" src="assets/images/hero1.jpg" alt="hero 1" />
        <p class="my-2 md:text-xl">
            Millions of Seniors are rushing the hotlines to secure their 2024 Medicare Advantage benefit
        </p>
        <p class="my-2 md:text-xl">
            <strong>Benefir Plans and options are always changing.</strong> so speak to our licensed sales agents and choose right medicare Advantage plan beforeenrollment ends
        </p>
        <div>
            <div id="display1" class="md:mt-8 mt-4">
                ...
                <div class="grid grid-cols-1  gap-6">
                    ...
                    <button id="btn-2" class="flex justify-center bg-blue-500 hover:bg-blue-500  tracking-wide text-white font-bold rounded-2xl md:w-3/4 w-1/2 mx-auto border-b-2 border-green-500 uppercase shadow-md md:py-6 py-4 md:text-2xl px-6 items-center">65
                        - 74
                    </button>
                    <button id="btn-3" class="flex justify-center bg-blue-500 hover:bg-blue-500  tracking-wide text-white font-bold rounded-2xl md:w-3/4 w-1/2 mx-auto border-b-2 border-green-500 uppercase shadow-md md:py-6 py-4 md:text-2xl px-6 items-center">76
                        and older
                    </button>
                </div>
            </div>
            <div id="display2" class="md:mt-8 mt-4 hidden">
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <button id="btn-no" class="flex justify-center bg-green-500 hover:bg-blue-500  tracking-wide text-white font-bold rounded-2xl md:w-3/4 w-1/2 mx-auto border-b-2 border-green-500 uppercase shadow-md md:py-6 py-4 md:text-2xl px-6 items-center cta_btn btn_2">
                        No
                    </button>
                </div>
            </div>
            <div id="display3" class="md:mt-8 mt-4 hidden">
                ...
                <div class="grid grid-cols-1 gap-6">
                    <button id="btn-yes1" class="flex justify-center bg-blue-500 hover:bg-blue-500  tracking-wide text-white font-bold rounded-2xl md:w-3/4 w-1/2 mx-auto border-b-2 border-green-500 uppercase shadow-md md:py-6 py-4 md:text-2xl px-6 items-center cta_btn btn_2">

                        Yes
                    </button>
                    <button id="btn-no1" class="flex justify-center bg-blue-500 hover:bg-blue-500  tracking-wide text-white font-bold rounded-2xl md:w-3/4 w-1/2 mx-auto border-b-2 border-green-500 uppercase shadow-md md:py-6 py-4 md:text-2xl px-6 items-center cta_btn btn_2">
                        No
                    </button>
                </div>
            </div>
    ...
    <div id="display4" class="hidden hidden mx-auto md:pt-4 pt-1 px-4 md:px-0 max-w-5xl container ">
        <div class="p-6 border-t-2 border-blue-500 mt-4 bg-gray-300 text-center shadow-xl">
            ...
            <a href="tel:<?php echo $ringbaNumberPrimaryTel; ?>">
                <button class="capitalize font-bold  bg-blue-500 animate__animated animate__pulse animate__infinite  text-white my-4 p-5  shadow-2xl md:text-2xl text-base">
                    Click to Call
